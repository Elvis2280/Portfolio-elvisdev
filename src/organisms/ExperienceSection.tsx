  ...
  return (
    <section className="relative overflow-hidden bg-background pb-8 ">
      ...
      <div className="relative z-10 px-4 pt-32 max-w-4xl">
        ...
        <p className="mt-8 text-body text-muted-foreground/80 leading-relaxed max-w-2xl md:text-lg xl:text-xl">
      ...
      <div className="absolute bottom-[5%] right-[33%] z-[1] pointer-events-none w-[450px] h-[450px] overflow-visible hidden xl:block xl:left-[50%]">
        <Observatorio
