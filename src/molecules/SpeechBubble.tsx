  ...
  return (
    <div className="relative flex flex-col">
      <div
        ref={containerRef}
        className={cn(
          'relative z-10 flex-1 bg-secondary/50 border border-border rounded-lg px-4 py-4 text-foreground text-xs font-sans animate-speech-entrance h-20 overflow-y-scroll scrollbar-none min-w-56 md:min-w-80 xl:min-w-96 md:text-md md:h-32',
          className,
        )}
      >
